...
import { getGatePassRequest, searchReceiverByServiceNo, getImageUrl, getExecutiveOfficers, updateExecutiveOfficer } from '../services/RequestService';//request to Request
import { 
  FaClock, 
  FaEye,
  FaUser, 
        ...
        <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="bg-blue-50 rounded-xl p-6 mb-6">
            <h3 className="text-lg font-semibold text-blue-800 flex items-center mb-4">
              <FaUser className="mr-2" /> Responsiable Person
            </h3>
...
export default GatePassItemTracker;